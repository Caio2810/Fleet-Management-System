 ...
 */
public class Relatorio6 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Selecione o veículo e ano");
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGroup(layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING,
                                                                false)
                                                        .addComponent(comboBoxVeiculos, 0, 380, Short.MAX_VALUE)
    ...
    private void btGerarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btGerarRelatorioActionPerformed
        // TODO add your handling code here:
        String veiculoItem = (String) comboBoxVeiculos.getSelectedItem(); // Obtém a string completa
        String anoStr = txtFieldAno.getText().trim();

        if (comboBoxVeiculos.getSelectedIndex() == 0 || anoStr.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this,
                    "Por favor, selecione um veículo e insira o ano.", // Mensagem corrigida
    ...
    private void gerarRelatorio(String veiculoID, int ano) throws Exception {
        try {
            ArrayList<Movimentacao> listar = controladoraMovimentacao.listarMultasPorVeiculoEAno(veiculoID, ano);
            double totalGasto = controladoraMovimentacao.calcularTotalMultasPorVeiculoEAno(veiculoID ,ano);

            controladoraMovimentacao.gerarRelatorio6PDF(veiculoID, ano, totalGasto, listar);
        } catch (Exception e) {
            // todo: arrumar erro
        }
    }
