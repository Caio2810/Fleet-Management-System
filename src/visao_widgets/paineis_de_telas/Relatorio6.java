...
public class Relatorio6 extends javax.swing.JPanel {
        ...
        private void btGerarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btGerarRelatorioActionPerformed
                ...
                try {
                        ...
                        javax.swing.JOptionPane.showMessageDialog(this, "Ano inválido. Use 4 dígitos numéricos.",
                                        "Erro de Formato",
                                        javax.swing.JOptionPane.ERROR_MESSAGE);
                } catch (Exception e) {
                        e.printStackTrace();
                        javax.swing.JOptionPane.showMessageDialog(this, "Erro ao gerar o relatório: " + e.getMessage(),
                                        "Erro",
                                        javax.swing.JOptionPane.ERROR_MESSAGE);
                }
        ...
        private void carregarVeiculos() {
                try {
                        ...
                        if (listaVeiculos == null || listaVeiculos.estaVazia()) { // .isEmpty() alterado para
                                                                                  // .estaVazia()
                        ...
                        for (Veiculo v : listaVeiculos) {
                                String itemFormatado = String.format("%s - %s, %s, %s, %d",
                                                v.getIdDeVeiculo(), v.getPlaca(), v.getMarca(), v.getModelo(),
        ...
        private void gerarRelatorio(String veiculoID, int ano) throws Exception {
                try {
                        ...
                        ListaEncadeada<Movimentacao> listar = controladoraMovimentacao
                                        .listarMultasPorVeiculoEAno(veiculoID, ano);
