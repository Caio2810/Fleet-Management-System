...
public class ControladoraVeiculos {
    ...
    public void carregarTabela(JTable tabela) throws Exception {
        ListaEncadeada<Veiculo> lista = dao.listarVeiculos();
    ...
    public String contadorVeiculosAtivos() throws Exception {
        try {
            ListaEncadeada<Veiculo> todosVeiculos = dao.listarVeiculos();
            int contador = 0;
    ...
    public void gerarRelatorio5PDF(ListaEncadeada<Veiculo> veiculos) throws Exception {
        ...
        try {
            ...
            document.add(new Paragraph("Total de veículos inativos: " + veiculos.tamanho(), fonteNormal));
            document.add(new Paragraph("\n"));
